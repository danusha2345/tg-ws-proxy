...
> [!WARNING]
>
> Tray проверен на Windows 11 x64. Windows ARM64 проходит CI, но ещё нуждается
> в пользовательской проверке на реальном устройстве.
...
После запуска приложение покажет сообщение, что оно работает в системном трее.
